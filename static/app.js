...
const els = { division: $("division"), district: $("district"), upazila: $("upazila"), survey: $("survey"), mouza: $("mouza"), search: $("search"), searchBtn: $("searchBtn"), rows: $("rows"), count: $("count"), preview: $("preview"), pdfFrame: $("pdfFrame"), download: $("download"), print: $("print") };
let currentPdf = "";
